...
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -s v -l verbose -d 'Verbose diagnostics: echo per-file extractor warnings to stderr'
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -l project-fuzzy -d 'Opt in to project-family matching. By default project filters are exact and an ambiguous bare repository name fails closed'
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "rebuild" -d 'Walk all source roots and rewrite `~/.aicx/catalog/sessions.jsonl`'
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "status" -d 'Compare durable catalog fingerprints to live agent sources (no write)'
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "resolve" -d 'Resolve one session id from the durable catalog'
complete -c aicx -n "__fish_aicx_using_subcommand catalog; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -s v -l verbose -d 'Verbose diagnostics: echo per-file extractor warnings to stderr'
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -l project-fuzzy -d 'Opt in to project-family matching. By default project filters are exact and an ambiguous bare repository name fails closed'
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "rebuild" -d 'Walk all source roots and rewrite `~/.aicx/catalog/sessions.jsonl`'
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "status" -d 'Compare durable catalog fingerprints to live agent sources (no write)'
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "resolve" -d 'Resolve one session id from the durable catalog'
complete -c aicx -n "__fish_aicx_using_subcommand store; and not __fish_seen_subcommand_from rebuild status resolve help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
