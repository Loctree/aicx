...
# REDACTED 2026-05-08: this file historically hardcoded a real Brave
# Search API key. The leaked value has been rotated. Reading from env
# instead — set BRAVE_API_KEY before invoking the script.
API_KEY = os.environ.get("BRAVE_API_KEY", "<unset: export BRAVE_API_KEY=...>")
