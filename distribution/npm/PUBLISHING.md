...
```bash
curl -LI https://github.com/Loctree/aicx/releases/download/v0.12.0/aicx-v0.12.0-aarch64-apple-darwin-slim-unsigned.tar.gz
curl -LI https://github.com/Loctree/aicx/releases/download/v0.12.0/aicx-v0.12.0-aarch64-apple-darwin-slim-unsigned.tar.gz.sha256
curl -LI https://github.com/Loctree/aicx/releases/download/v0.12.0/aicx-v0.12.0-x86_64-unknown-linux-gnu-slim-unsigned.tar.gz
curl -LI https://github.com/Loctree/aicx/releases/download/v0.12.0/aicx-v0.12.0-x86_64-unknown-linux-gnu-slim-unsigned.tar.gz.sha256
```
