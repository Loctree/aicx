...
```bash
node distribution/npm/sync-version.mjs 0.13.1
node distribution/npm/stage-platform-package.mjs 0.13.1 darwin-arm64 /path/to/release-input
node distribution/npm/verify-metadata.mjs 0.13.1 --platform=darwin-arm64
```
