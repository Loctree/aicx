...
```bash
node distribution/npm/sync-version.mjs 0.9.2
node distribution/npm/sync-version.mjs --check 0.9.2
node distribution/npm/verify-metadata.mjs 0.9.2
```
...
```bash
curl -LI https://github.com/Loctree/aicx/releases/download/v0.9.2/aicx-v0.9.2-aarch64-apple-darwin-slim-unsigned.tar.gz
curl -LI https://github.com/Loctree/aicx/releases/download/v0.9.2/aicx-v0.9.2-aarch64-apple-darwin-slim-unsigned.tar.gz.sha256
curl -LI https://github.com/Loctree/aicx/releases/download/v0.9.2/aicx-v0.9.2-x86_64-unknown-linux-gnu-slim-unsigned.tar.gz
curl -LI https://github.com/Loctree/aicx/releases/download/v0.9.2/aicx-v0.9.2-x86_64-unknown-linux-gnu-slim-unsigned.tar.gz.sha256
```
