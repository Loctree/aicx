...
```bash
node distribution/npm/sync-version.mjs 0.8.1
node distribution/npm/sync-version.mjs --check 0.8.1
node distribution/npm/verify-metadata.mjs 0.8.1
```
...
```bash
curl -LI https://github.com/Loctree/aicx/releases/download/v0.8.1/aicx-v0.8.1-aarch64-apple-darwin-slim-unsigned.tar.gz
curl -LI https://github.com/Loctree/aicx/releases/download/v0.8.1/aicx-v0.8.1-aarch64-apple-darwin-slim-unsigned.tar.gz.sha256
curl -LI https://github.com/Loctree/aicx/releases/download/v0.8.1/aicx-v0.8.1-x86_64-unknown-linux-gnu-slim-unsigned.tar.gz
curl -LI https://github.com/Loctree/aicx/releases/download/v0.8.1/aicx-v0.8.1-x86_64-unknown-linux-gnu-slim-unsigned.tar.gz.sha256
```
