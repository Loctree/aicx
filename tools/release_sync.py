    ...
    return (
        ...
        TextSurface(
            ...
            transforms=(
                ...
                (
                    r'git tag -as? v\d+\.\d+\.\d+ -m "(?:(?:ai-contexters|aicx) v|Release v)\d+\.\d+\.\d+"',
                    f'git tag -as v{version} -m "Release v{version}"',
                    0,
        ...
        TextSurface(
            ...
            transforms=(
                ...
                (
                    r"https://github\.com/Loctree/aicx/releases/download/v\d+\.\d+\.\d+/aicx-v\d+\.\d+\.\d+-aarch64-apple-darwin-slim\.zip",
                    f"https://github.com/Loctree/aicx/releases/download/v{version}/aicx-v{version}-aarch64-apple-darwin-slim.zip",
                    0,
                    "distribution/npm/PUBLISHING macOS archive URL example",
                ),
                (
                    r"https://github\.com/Loctree/aicx/releases/download/v\d+\.\d+\.\d+/aicx-v\d+\.\d+\.\d+-aarch64-apple-darwin-slim\.zip\.sha256",
                    f"https://github.com/Loctree/aicx/releases/download/v{version}/aicx-v{version}-aarch64-apple-darwin-slim.zip.sha256",
                    0,
                    "distribution/npm/PUBLISHING macOS checksum URL example",
                ),
                (
                    r"https://github\.com/Loctree/aicx/releases/download/v\d+\.\d+\.\d+/aicx-v\d+\.\d+\.\d+-x86_64-linux-gnu-slim\.tar\.gz",
                    f"https://github.com/Loctree/aicx/releases/download/v{version}/aicx-v{version}-x86_64-linux-gnu-slim.tar.gz",
                    0,
                    "distribution/npm/PUBLISHING linux release archive URL example",
                ),
                (
                    r"https://github\.com/Loctree/aicx/releases/download/v\d+\.\d+\.\d+/aicx-v\d+\.\d+\.\d+-x86_64-linux-gnu-slim\.tar\.gz\.sha256",
                    f"https://github.com/Loctree/aicx/releases/download/v{version}/aicx-v{version}-x86_64-linux-gnu-slim.tar.gz.sha256",
                    0,
                    "distribution/npm/PUBLISHING linux checksum URL example",
                ),
                (
                    r"https://github\.com/Loctree/aicx/releases/download/v\d+\.\d+\.\d+/aicx-v\d+\.\d+\.\d+-x86_64-pc-windows-msvc-slim\.zip",
                    f"https://github.com/Loctree/aicx/releases/download/v{version}/aicx-v{version}-x86_64-pc-windows-msvc-slim.zip",
                    0,
                    "distribution/npm/PUBLISHING Windows archive URL example",
                ),
                (
                    r"https://github\.com/Loctree/aicx/releases/download/v\d+\.\d+\.\d+/aicx-v\d+\.\d+\.\d+-x86_64-pc-windows-msvc-slim\.zip\.sha256",
                    f"https://github.com/Loctree/aicx/releases/download/v{version}/aicx-v{version}-x86_64-pc-windows-msvc-slim.zip.sha256",
                    0,
                    "distribution/npm/PUBLISHING Windows checksum URL example",
                ),
            ),
        ),
    )
